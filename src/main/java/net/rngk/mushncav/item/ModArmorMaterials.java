...
public enum ModArmorMaterials implements ArmorMaterial {
    GLOWING_SAPPHIRE("glowing_sapphire", 33, new int[] { 3, 7, 5, 3 }, 15, null, 0.0F, 0.0F, () -> Ingredient.ofItems(ModItems.GLOWING_SAPPHIRE_STONE));
    ...
    public String getName() {
        return MushroomsAndCaverns.MOD_ID + ":" + this.name;
    }
